...
- **Last updated:** 2026-08-07 (**R5 active** — R3 live on `gh-pages`; R4 code + testimonials **merged to `develop`**, deploy owner-gated; R5-1 glass foundation + **R5-2 header/hero glass implemented on `evolve-design`**, R5-3 awaiting owner gate)
