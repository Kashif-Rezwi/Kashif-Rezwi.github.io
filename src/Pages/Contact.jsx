...
export const Contact = () => {
    return (
        <Stack justify={"space-between"} pt={"70px"} align={"center"} h={"100vh"} w={"100%"} name={"contact"} position={"relative"}>
            ...
            <Box>
                ...
                <Grid templateColumns={{ base: "repeat(1,1fr)", sm: "repeat(1,1fr)", md: "repeat(2,1fr)", lg: "repeat(2,1fr)" }} maxW={"989px"} m={"auto"}>
                    ...
                    <Stack pl={{ base: "0px", sm: "0px", md: "20px", lg: "50px" }}>
                        ...
                        <Stack m={"auto"} w={"350px"} p={"40px 20px"} borderRadius={"10px"} boxShadow="rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px" _hover={{ boxShadow: "rgba(0, 0, 0, 0.16) 0px 10px 36px 0px, rgba(0, 0, 0, 0.06) 0px 0px 0px 1px" }} transition={"0.5s"}>
                            ...
                            <FormControl mb={"10px"}>
                                ...
                                <Textarea maxH={"200px"} placeholder='Write your valueable feeback here...' />
                            </FormControl>

                            <Button _hover={{ bg: "#4c87f1" }} _active={{ bg: "#033b9f" }} color={"#f8f7fd"} bg={"#3e75d7"}>Send</Button>
            ...
            <UnorderedList w={"100%"} display={{ base: "block", sm: "block", md: "none", lg: "none" }}>
                ...
                <Stack pt={"10px"} justify={"center"} align={"center"} mt={"20px"} bg={"cornflowerblue"} color={"white"} w={"100%"} p={"20px"} pb={"70px"}>
            ...
            <UnorderedList w={"100%"} display={{ base: "none", sm: "none", md: "block", lg: "block" }}>
                ...
                <Stack justify={"center"} align={"center"} bg={"cornflowerblue"} color={"white"} w={"100%"} p={"5px"}>
